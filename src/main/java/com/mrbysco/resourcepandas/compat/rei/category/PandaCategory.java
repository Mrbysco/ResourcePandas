...
//			ResourcePandaEntity resourcePanda = ClientHelper.getResourcePanda(display.getRecipeId());
//			if (resourcePanda != null) {
//				// Draw entity
//				RenderHelper.renderEntity(guiGraphics, bounds.x + 46, bounds.y + 52, 25.0F,
//						mouseX + 12,
//						mouseY - 12,
//						resourcePanda);
//			}
