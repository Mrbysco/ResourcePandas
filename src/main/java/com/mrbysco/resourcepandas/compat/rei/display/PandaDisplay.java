...
//					Identifier.CODEC.fieldOf("recipeId").forGetter(d -> d.recipeId)
...
//		this.recipeId = recipeHolder.id().identifier();
//	}
//
//	public PandaDisplay(EntryIngredient input, EntryIngredient output, String hexColor, Float alpha, Float chance, Identifier recipeId) {
//		this.input = input;
//		this.output = output;
